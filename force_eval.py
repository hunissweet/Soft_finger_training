...
class ForceEstimator(RosDataHandler):
    ...
    def __init__(self, data_streams, seq_len=1):
        ...
        self.model=GRUModel_V2(
            ...
            dropout_prob=0,
            device=self.device)
        self.model.load_state_dict(torch.load("./comp/st.pth",map_location=torch.device(self.device)))
        ...
        self.vecs = []
        self.cal_val=[]
        self.x_scaler=joblib.load('./comp/X_st.save')
        self.y_scaler=joblib.load('./comp/Y_st.save')
